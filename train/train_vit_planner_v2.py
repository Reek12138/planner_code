...
"""
Train VelocityPlannerModel V2 with metadata.jsonl (4-frame depth -> 3-axis velcmd)
...
def main():
    ...
    ap.add_argument("--img_size", type=int, default=128, help="input image size (V2 default: 128)")
